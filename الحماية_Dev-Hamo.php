...
─═ঊঈঊঈ═─╯
*/
define('API_KEY','7002802886:AAFbisb8geg-Wylo7p1KHMklzu-Fwhoks7I');
//-----------------------------------------------------------------------------------------
//فانکشن MrPHPBot :
...
تابع 🔉 من❕فضلك 👣 :- @ATT5O",
   ...
   [
['text'=>"فريق ATT5O 🚸",'url'=>"https://telegram.me/ATT5O"]
  ],
    ]
    ])
    ]);
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @ATT5O 🔉");
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @ATT5O 🔉");
SendMessage($chat_id,"تم تفعيل ⚡️ البوت في المجموعة 🐾 لرؤية قوائم الحماية ♻️ ارسل الاوامر 🚸 تابع :- @ATT5O ❕");
}
}
...
[اضغط هنا وتابع جديدنا ✔️](t.me/ATT5O)",
  'parse_mode'=>'MarkDown',
	]);
	}
 }
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم طرد ☄ العضو بنجاح ⚡️ تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
save("data/$from_id/file.txt","sendtoall");
         MrPHPBot('sendmessage',[
        	'chat_id'=>$Dev,
        	'text'=>"ارسل ⚡️ النص ☄ الان 🌪 تابع @ATT5O 📨",
		'parse_mode'=>'MarkDown',
    		]);
...
SendMessage($chat_id,"تم حفظ ☄ الترحيب بنجاح ⚡️ تابع :- @ATT5O 🐾");
}
}
...
SendMessage($chat_id,"تم حفظ ☄ التكرار بنجاح ⚡️ تابع :- @ATT5O 🐾");
}
else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 20 ⚡️ تابع :- @ATT5O 🐾",
              ]);
}
}
}
...
SendMessage($chat_id,"تم تفعيل ☄ الترحيب بنجاح ⚡️ تابع :- @ATT5O 🐾");
}
}
elseif ($textmassage == "كتم التكرار" && $from_id == $Dev) {
rmdir("data/spam");
mkdir("data/spam");
SendMessage($chat_id,"#تم تابع @ATT5O");
}
...
elseif (preg_match('/^(.*)([Bb][Oo][Tt])/s',$newchatmemberu) && $lockbots == "✔️" && $newchatmemberu != "SPDLBot") {
 MrPHPBot('sendMessage',[
 'chat_id'=>$chat_id,
 'text'=>'عذرا عزيزي ☄ ممنوع اضافة البوتات 🐾 هنا للاسف تم طرده ⚡️ تابع من فضلك :- @ATT5O 🚸',
  'parse_mode'=>'HTML'
 ]);
 MrPHPBot('kickChatMember',[
 'chat_id'=>$chat_id,
...
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text' =>"تم حذف ☄ $num من الرسائل ⚡️ تابع :- @ATT5O 🐾",
              ]);
}else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 100 ⚡️ تابع :- @ATT5O 🐾",
              ]);
}
}
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ اسم المجموعة ☄ بنجاح تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ وصف المجموعة ☄ بنجاح تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم الغاء تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"ارسل صورة ⚡️ للمجموعة الان ☄ تابع :- @ATT5O 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  MrPHPBot('sendmessage',[
  'chat_id'=>$chat_id,
  'text'=>"   اعدادت ♻️ التكرار اختر ☄ من 1 الى 20 🐾 تابع عزيزي 🔉 @ATT5O 🌪",
  'parse_mode'=>'MarkDown',
  'reply_markup'=>json_encode([
  'resize_keyboard'=>true,
  'inline_keyboard'=>[
...
}
{
   MrPHPBot('answerInlineQuery', [
        ...
        'results' => json_encode([[
            ...
            'title' => 'ATT5O',
            'input_message_content' => ['parse_mode' => 'MarkDown', 'message_text' => "*Follow ATT5O * ⚡️
...
*Channels📡 : •┇Dev Hamo┇•*"],
            'reply_markup' => [
                'inline_keyboard' => [
                    [
                        ['text' => "جديدنا", 'url' => 'https://telegram.me/ATT5O']
                    ],
                    [
...
?>
n', 'message_text' =arse_mode' => 'MarkDown', 'message_text' => "*Follow ATT5O * ⚡️
