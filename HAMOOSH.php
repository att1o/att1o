<?php
ob_start();
$API_KEY = "7002802886:AAFbisb8geg-Wylo7p1KHMklzu-Fwhoks7I";// توكن بوتك العزيز
$buy = "@att1o";//  يوزرك تليكرام .
$sudo = "5862645366";// خلي ايديك هنا .
$admin = "$sudo";// عوفة لا تبعبص بي .
$idBot = "7002802886";// ايدي بوتك خلي بشكل صحيح .
$admmm = $sudo;// لا تبعصة عوفة .
$Dev = array("$sudo", "" );
$userrr = "Sel6nbot"; # خلي معرف بوتك بدون نيم ( @ )
...
$Dev = array("$admmm","5862645366"); # حط ايدي المطور ثاني المساعد او بكيفك خلي ايديك .
$channel = "att5o";
$token = API_KEY;
...
file_put_contents("SudoOrders/namebot.txt","سيلينا");
bot("sendMessage",["chat_id"=>$chat_id,'text'=>"⌔︙اهلا عزيزي » [$info](tg://user?id=$from_id) \n⌔︙ارسل اسم البۄت الان \n ✓",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}}
...
$botproxre = array("صيحولي سيلينا كافي بوت 😒🔪","لتكول بوت اسمي سيلينا 😒🔪","عندي اسم تره 😒💔","انت البوت لك 😒💔");
...
$proxre = array("😸♥️ هلا كلبي وياك سيلينا تفضل","ترةه مصختهاا احجيي شرايد 😕😒💔","اطلقق واحدد يصيح سيلينا 😻♥️","خبصتت امنةة شتريدد عااد 🤧😒💔");
$reprox = array_rand($proxre, 1);
if($text == "سيلينا" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
bot('sendmessage',['chat_id'=>$chat_id,'text'=>"⌔︙مرحبا انا بوت اسمي سيلينا
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/att5o)
...
'reply_markup'=>json_encode([
 'keyboard'=>[
[ ['text'=>"تعيين اسم البوت"],['text'=>"ضع كليشه المطور"] ],
[['text'=>"» المشتركين ⌔"],['text'=>"» المطورين ⌔"]],
[['text'=>"» اذاعه عام ⌔"],['text'=>"» اذاعه خاص ⌔"]],
[['text'=>"» اذاعه عام بالتوجيه ⌔"],['text'=>"» اذاعه خاص بالتوجيه ⌔"]],
[['text'=>"⌯تعيين كلايش الاوامر ⌯"],['text'=>"تحديث السورس"]],
[['text'=>"» تحديث ⌔"],['text'=>"» المجموعات ⌔"]],
[['text'=>"تعطيل البوت الخدمي"],['text'=>"تفعيل البوت الخدمي"]],
[['text'=>"حذف قناة الاشتراك"],['text'=>"قناة الاشتراك"]],
[['text'=>"تعيين قناة الاشتراك"],['text'=>"ِ» حظر مجموعة ⌔"]],
[['text'=>"تعطيل الاشتراك الاجباري"],['text'=>"تفعيل الاشتراك الاجباري"]],
[['text'=>"» حذف رد التواصل ⌔"],['text'=>"» تعيين رد التواصل ⌔"]],
[['text'=>"» جلب رد التواصل ⌔"],['text'=>"» تعطيل التواصل ⌔"]],
[['text'=>"» تفعيل التواصل ⌔"],['text'=>"» حذف رد عام ⌔"]],
[['text'=>"» اضف رد عام ⌔"],['text'=>"» الاحصائيات ⌔"]],
[['text'=>"» حذف رد الخاص ⌔"],['text'=>"» تعيين رد الخاص ⌔"]],
[['text'=>"» الردود العام ⌔"],['text'=>"» تعطيل رد الخاص ⌔"]],
[['text'=>"» تفعيل رد الخاص ⌔"],['text'=>"» جلب رد الخاص ⌔"]],
],
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/att5o"]
],
]
])
]);
...
⌔︙[ اضغط هنا لديك مفاجئه ](https://t.me/att5o)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
...
bot("sendmessage",[
'chat_id'=>$chat_id,
'text'=>"► : هلان بك في سورس حمو المجاني
",
'parse_mode'=>'markdown',
'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'‹ اضغط هنا لشراء بوت حماية .','url'=>"t.me/att5o"]],
[['text'=>'‹ تابع قناة تحديثات السورس .','url'=>"t.me/att5o"]],
[['text'=>'‹ تابع تيم السورس وكل تحديث .','url'=>"t.me/att5o"]],
[['text'=>'‹ مبرمج السورس ›','url'=>"t.me/att1o"]],
]
])
]); 
} 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'⌔︙تابع قناة السورس','url'=>'https://t.me/att5o']],]])]);}}}
...
'السورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','السورس زربه' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس حمو' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس حمو' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عبس' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪',
...
$fast = array('⌔︙اسرع واحد يرسل { عباس } يربح','⌔︙اسرع واحد يرسل { بغداد } يربح','⌔︙اسرع واحد يرسل { قناة } يربح','⌔︙اسرع واحد يرسل { سيلينا } يربح','⌔︙اسرع واحد يرسل { رمضان } يربح','⌔︙اسرع واحد يرسل { لابتوب } يربح','⌔︙اسرع واحد يرسل { كمبيوتر } يربح','⌔︙اسرع واحد يرسل { تلفون } يربح','⌔︙اسرع واحد يرسل { مطبخ } يربح','⌔︙اسرع واحد يرسل { اليمن } يربح','⌔︙اسرع واحد يرسل { سوريا } يربح','⌔︙اسرع واحد يرسل { العراق } يربح','⌔︙اسرع واحد يرسل { السعوديه } يربح','⌔︙اسرع واحد يرسل { مصر } يربح','⌔︙اسرع واحد يرسل { السودان } يربح');
...
if(in_array($chat_id,$game1) and $text == 'كمبيوتر' or $text == 'عباس'  or $text == 'اليمن'  or $text == 'مصر'  or $text == 'السودان'  or $text == 'سوريا' or  $text == 'العراق' or $text == 'رمضان' or $text == 'لابتوب' or $text == 'تلفون' or $text == 'سيلينا' or $text == 'قناة' or $text == 'بغداد' or $text == 'مطبخ'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("data/$chat_id/game.txt","");
...
bot('sendMessage',['chat_id'=>$chat_id,'text'=>"جاري تحديث سورس حمو ►︙",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message->message_id,]);
sleep(1);
